...
pub fn get_rocket_design() -> MissileConfig {
    MissileConfig {
        ...
        controller: MissileControllerConfig {
            pitch_pid_kp: vec![
                (Time::new::<second>(0.0), 60.143385),
                (Time::new::<second>(5.2), 60.283767),
                (Time::new::<second>(10.4), 60.267449),
            ],
            pitch_pid_ki: vec![
                (Time::new::<second>(0.0), 0.077253),
                (Time::new::<second>(5.2), 0.000000),
                (Time::new::<second>(10.4), 1.349533),
            ],
            pitch_pid_kd: vec![
                (Time::new::<second>(0.0), 8.329816),
                (Time::new::<second>(5.2), 8.196671),
                (Time::new::<second>(10.4), 8.148735),
            ],
            yaw_pid_kp: vec![
                (Time::new::<second>(0.0), 60.143385),
                (Time::new::<second>(5.2), 60.283767),
