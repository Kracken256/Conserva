...
- [x] **Wind & Turbulence Modeling**: Introduce atmospheric disturbances such as steady crosswinds and randomized turbulence gusts (e.g., Dryden model).
- [x] **Advanced Atmosphere (ISA)**: Ensure the atmosphere model dynamically adjusts temperature, pressure, density, and local speed of sound against extreme altitude variations.
